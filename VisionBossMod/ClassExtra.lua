...
function VBM_ClassExtra_OnLoad()
...
function VBM_ClassExtra_OnEvent()
	...
	--debugg
	--if(vbm_test_all_events()) then return; end
	...
	if(event == "BAG_UPDATE") then
		VBM_WarlockSoulShardUpdate(arg1);
	end
...
function vbm_test_spell_casting()
...
function vbm_test_all_events()
	local str = "event = \""..event.."\"";
	local i=1;
	local enter = "";
	while (_G["arg"..i]) do
		if(type(_G["arg"..i])=="boolean") then
			if(_G["arg"..i]) then enter = "true"; else enter = "false"; end
		else
			enter = _G["arg"..i];
		end
		str = str..", arg"..i.." = \""..enter.."\"";
...
function vbm_test_combatlog()
	local timestamp, event, sourceGUID, sourceName, sourceFlags, destGUID, destName, destFlags = arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8;
	local str = "";
	...
	if(arg9) then str = str.." arg9="..arg9; end
...
function VBM_FeignDeathResistWarn()
...
function VBM_SoulshatterResist()
	local combatEvent, sourceName, destName = arg2,arg4,arg7;
	--if your spell has missed
	if(combatEvent == "SPELL_MISSED" and sourceName and sourceName==VBM_YOU) then
		local spellName, missType = arg10,arg12;
...
function VBM_AspectViperNotice()
	local combatEvent, sourceName, destName = arg2,arg4,arg7;
...
function VBM_MaelstromWeaponTracker()
	local combatEvent, sourceName, destName = arg2,arg4,arg7;
	...
	if(destName and destName==VBM_YOU and (combatEvent == "SPELL_AURA_APPLIED" or combatEvent == "SPELL_AURA_APPLIED_DOSE" or
		...
		local spellName,amount = arg10,arg13;
