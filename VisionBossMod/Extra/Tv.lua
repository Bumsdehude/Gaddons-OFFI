...
function VBMTV_OnUpdate()
	--update visible bars
	VBMTV_UpdateVisible();
	--dont update to fast
	if(this.lastupdate and this.lastupdate + vbmtv_update_time > GetTime()) then
		return;
	end
