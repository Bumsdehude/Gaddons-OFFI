...
function VBM_Anetheron_Infernal()
	if(VBM_MSG_FROM==VBM_YOU) then
		VBM_Delay(0.2,VBM_BossTargetYouWarning,"Anetheron","Infernal incomming on You!","Infernal incomming on Me! Run!");
	else
...
function VBM_Archimonde_AirBurst()
	if(VBM_MSG_FROM==VBM_YOU) then
		VBM_Delay(0.2,VBM_BossTargetYouWarning,"Archimonde","Air Burst incomming on You!","Air Burst incomming on Me! Run!");
	else
