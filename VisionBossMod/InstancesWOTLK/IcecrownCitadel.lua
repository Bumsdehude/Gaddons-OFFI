...
VBM_LoadInstance["Icecrown Citadel"] = function()
	...
	***************************************************************
		...
		spells = {
			...
			["Unstable Ooze Explosion"] = {
				...
				func = function()
					...
					VBM_Delay(5,VBM_WarnTextCountdown,3,"Watch Out",vbm_c_bronze,"big");
				end,
			},
	...
	VBM_BOSS_DATA["Professor Putricide"] = {
		...
		debuffs = {
			["Volatile Ooze Adhesive"] = {"* * * Volatile Ooze Adhesive * * *",function() 
				vbm_say("Volatile Ooze Adhesive - "..VBM_YOU);
			end},
			["Gaseous Bloat"] = {"* * * Gaseous Bloat * * *",function() 
				vbm_say("Gaseous Bloat - "..VBM_YOU); 
			end},
			--hard mode only
			["Unbound Plague"] = {"* * * Unbound Plague * * *",function() 
		...
		spells = { 
			...
			["Shock Vortex"] = {
				...
				func = function()
					...
					VBM_Delay(0.25,VBM_BossTargetYouWarning,"Prince Valanar","","Shock Vortex - "..VBM_YOU,"Shock Vortex");
				end,
			},
	...
	VBM_BOSS_DATA["Sindragosa Dummy"] = {
		...
		spells = { 
			...
			["Frost Beacon Tracker"] = {
				...
				func = function(s,d)
					...
					elseif(VBM_DUNGEON_DIFFICULTY==2 and VBM_DUNGEON_SIZE==25) then
		...
		during = function()
			...
			for i=1,GetNumRaidMembers() do
				...
				if(name and count > 4 and not VBM_FAILED) then
					VBM_FAILED = true;
	...
	VBM_BOSS_DATA["The Lich King"] = {
		...
		spells = {
			...
			["Summon Shadow Trap"] = {
				...
				color = "grey",
				func = function()
					VBM_Delay(0.25,VBM_BossTargetYouWarning,"The Lich King","* * * Shadow Trap on YOU * * *","Shadow Trap - "..VBM_YOU,"Summon Shadow Trap");
				end,
			},
			--victory 
			["Fury of Frostmourne"] = {
			...
			["Defile"] = {
				...
				color = "grey",
				func = function()
					VBM_Delay(0.25,VBM_BossTargetYouWarning,"The Lich King","* * * Defile on YOU * * *","Defile - "..VBM_YOU,"Defile");
				end,
			},
			["Defile Damage"] = {
				event = "SPELL_DAMAGE",
