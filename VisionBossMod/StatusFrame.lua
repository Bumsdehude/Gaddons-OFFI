...
function VBM_StatusFrame_Init()
	...
	VBM_CreateExtraMenuFrames(4,15);
...
function VBM_PopulateWellFedTooltip()
...
function VBM_PopulateFlaskTooltip()
...
function VBM_Rebirth_Tracking() --getting from extrafeatures.lua
...
function VBM_PopulateRebirthTooltipOnUpdate(self)
